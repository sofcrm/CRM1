...
class ClientController extends Controller
{
        ...
        public function indexf()
        {
            ...
            $Leads = DB::table('clients')->where('Stage','=',"Lead in" )->get();
            $Meetings = DB::table('clients')->where('Stage','=',"Meeting" )->get();
            $Contacts = DB::table('clients')->where('Stage','=',"Contact Made" )->get();
            $Proposals = DB::table('clients')->where('Stage','=',"Proposal Sent" )->get();
           /* dd($Leads, $Meetings, $Contacts, $Proposals );*/
            return view('admin.Vsummry',compact('Proposals','Leads','Meetings','Contacts'));
        }
