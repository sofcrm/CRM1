                 ...
                 <div class="col-lg-12">
                    <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <input class="form-control " id="curl" type="text"  name="name_event"  /required>
                                    </div>
                                    <div class="form-group">
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                     <label class="col-lg-2 control-label"> Status</label>
                                          <div class="col-lg-9">
                                           <input type="date"  name="Estauts" class="form-control" cols="30" rows="5"></input>
                                </div>
                                                   ...
                                                   <div >
                                                       <table class="table" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="col-lg-7">Details</th>
                                                           <th class="col-lg-2" onclick="sortTable(0)" >Create Date & Time</th>
                                                            <th class="col-lg-2">Next Follow up</th>
                                                        ...
                                                        <tbody>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                            <button class="btn btn-primary" type="submit">Make it Done</button>
                                                            </td>
